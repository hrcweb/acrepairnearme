...
export const FLORIDA_SAMPLE_BUSINESSES: SampleBusiness[] = [
  ...
  // Additional businesses for better coverage

  // Boca Raton HVAC businesses
  {
    name: "Boca Raton Elite AC Services",
    description: "Premium air conditioning services in Boca Raton and South Palm Beach County. Luxury home specialists with 24/7 emergency service.",
    phone: "(561) 555-2801",
    email: "contact@bocaratoneliteac.com",
    website: "https://bocaratoneliteac.com",
    address: "1234 Yamato Rd",
    city: "Boca Raton",
    state: "FL",
    zip_code: "33431",
    services: ["AC Repair", "AC Installation", "Commercial HVAC", "Indoor Air Quality"],
  ...
  {
    name: "Delray Beach AC Solutions",
    description: "Professional HVAC services in Delray Beach area. Expert air conditioning repair and installation with competitive pricing.",
    phone: "(561) 555-2802",
    email: "service@delraybeachac.com",
    address: "5678 Congress Ave",
    city: "Boca Raton",
    state: "FL",
    zip_code: "33445",
    services: ["Emergency AC Service", "Heat Pump Service", "HVAC Maintenance", "Air Duct Cleaning"],
    rating: 4.7,
    review_count: 134,
    featured: false,
    insurance_verified: true,
    license_number: "CAC1843902",
    business_hours: {
      monday: "8:00 AM - 6:00 PM",
      tuesday: "8:00 AM - 6:00 PM",
      wednesday: "8:00 AM - 6:00 PM",
  ...
  // Pompano Beach HVAC businesses
  {
    name: "Pompano Beach AC Masters",
    description: "Expert air conditioning services in Pompano Beach and Broward County. Family-owned business with over 20 years experience.",
    phone: "(954) 555-2901",
    email: "info@pompanobeachacmasters.com",
    address: "2345 Federal Hwy",
    city: "Pompano Beach",
    state: "FL",
    zip_code: "33062",
    services: ["AC Repair", "AC Installation", "HVAC Maintenance", "Commercial HVAC"],
  ...
  {
    name: "Coral Springs HVAC Solutions",
    description: "Reliable HVAC contractor serving Coral Springs and Northwest Broward. Licensed air conditioning specialists with quality guarantee.",
    phone: "(954) 555-2902",
    email: "service@coralspringshvac.com",
    address: "6789 Sample Rd",
    city: "Pompano Beach",
    state: "FL",
    zip_code: "33065",
    services: ["Energy Efficiency", "Heat Pump Service", "Indoor Air Quality", "Emergency AC Service"],
    rating: 4.6,
    review_count: 156,
    featured: false,
    insurance_verified: true,
    license_number: "CAC1844002",
    business_hours: {
      monday: "8:00 AM - 6:00 PM",
      tuesday: "8:00 AM - 6:00 PM",
      wednesday: "8:00 AM - 6:00 PM",
  ...
  // Plantation HVAC businesses
  {
    name: "Plantation AC Experts",
    description: "Professional air conditioning services in Plantation and Southwest Broward. Expert HVAC technicians with same-day service.",
    phone: "(954) 555-3001",
    email: "contact@plantationacexperts.com",
    address: "3456 Peters Rd",
    city: "Plantation",
    state: "FL",
    zip_code: "33324",
    services: ["AC Repair", "AC Installation", "Emergency AC Service", "HVAC Maintenance"],
  ...
  },
  {
    ...
    description: "Trusted HVAC contractor in Sunrise and Plantation area. Licensed and insured with focus on customer satisfaction.",
    phone: "(954) 555-3002",
  ...
  // Hialeah HVAC businesses
  {
    name: "Hialeah AC Repair Pros",
    description: "Leading air conditioning services in Hialeah and Miami-Dade. Bilingual technicians with expertise in residential and commercial systems.",
    phone: "(305) 555-3101",
    email: "service@hialeahacrepair.com",
    address: "4567 W 49th St",
    city: "Hialeah",
    state: "FL",
    zip_code: "33012",
    services: ["AC Repair", "AC Installation", "Commercial HVAC", "Emergency AC Service"],
  ...
  {
    name: "Miami Lakes HVAC Solutions",
    description: "Professional HVAC services in Miami Lakes and Northwest Miami-Dade. Expert air conditioning repair with warranty coverage.",
    phone: "(305) 555-3102",
    email: "contact@miamilakeshvac.com",
    address: "8901 NW 154th St",
    city: "Hialeah",
    state: "FL",
    zip_code: "33016",
    services: ["HVAC Maintenance", "Heat Pump Service", "Air Duct Cleaning", "Indoor Air Quality"],
    rating: 4.7,
    review_count: 145,
    featured: false,
    insurance_verified: true,
    license_number: "CAC1846202",
    business_hours: {
      monday: "8:00 AM - 6:00 PM",
      tuesday: "8:00 AM - 6:00 PM",
      wednesday: "8:00 AM - 6:00 PM",
  ...
  // Additional Miami businesses
  {
    name: "Doral AC Specialists",
    description: "Premium air conditioning services in Doral and West Miami-Dade. Commercial and residential HVAC experts with 24/7 service.",
    phone: "(305) 555-3201",
    email: "info@doralacspecialists.com",
    address: "1234 NW 107th Ave",
    city: "Miami",
    state: "FL",
    zip_code: "33178",
    services: ["AC Repair", "AC Installation", "Commercial HVAC", "Energy Efficiency"],
    rating: 4.9,
    review_count: 234,
    featured: true,
    insurance_verified: true,
    license_number: "CAC1847301",
    business_hours: {
      monday: "6:00 AM - 10:00 PM",
      tuesday: "6:00 AM - 10:00 PM",
      wednesday: "6:00 AM - 10:00 PM",
  ...
  {
    name: "Kendall HVAC Masters",
    description: "Expert HVAC contractor serving Kendall and South Miami-Dade. Family-owned business with over 30 years experience in air conditioning.",
    phone: "(305) 555-3202",
    email: "service@kendallhvacmasters.com",
    address: "5678 SW 88th St",
    city: "Miami",
    state: "FL",
    zip_code: "33156",
    services: ["Emergency AC Service", "Heat Pump Service", "HVAC Maintenance", "Indoor Air Quality"],
    rating: 4.6,
    review_count: 189,
    featured: false,
    insurance_verified: true,
    license_number: "CAC1847302",
    business_hours: {
      monday: "7:00 AM - 7:00 PM",
      tuesday: "7:00 AM - 7:00 PM",
      wednesday: "7:00 AM - 7:00 PM",
